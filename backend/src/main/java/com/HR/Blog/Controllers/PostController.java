...
public class PostController {
	...
	@GetMapping("/allPost")
	public ResponseEntity<List<Post>> getAllPostInOnePage() {
	...
	public ResponseEntity<PostDto> editPost(@RequestBody PostDto postDto, @PathVariable Integer postId) {
		...
		PostDto updatePost = this.postService.editPost(postDto, postId);
	...
	public ResponseEntity<String> notLikePost(@PathVariable Integer postId) {
		postService.notLikePost(postId);
		return ResponseEntity.ok("Post liked successfully.");
	}

	@PostMapping("/posts/{postId}/dislike")
	public ResponseEntity<String> dislikePost(@PathVariable Integer postId) {
		postService.dislikePost(postId);
		return ResponseEntity.ok("Post disliked successfully.");
	}

	@PostMapping("/posts/{postId}/unDislike")
	public ResponseEntity<String> notDislikePost(@PathVariable Integer postId) {
		postService.notDislikePost(postId);
		return ResponseEntity.ok("Post liked successfully.");
	}
